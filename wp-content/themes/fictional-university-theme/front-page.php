...
<div class="page-banner">
    ...
    <div class="page-banner__content container t-center c-white">
        <h1 class="headline headline--large">Welcome
        </h1>
            ...
            while ($homepage_posts->have_posts()) {
                ...
                <div class="event-summary">
                    <a class="event-summary__date event-summary__date--beige t-center" href="<?php echo get_permalink(); ?>">
                        <span class="event-summary__month"><?php $date_format = 'M';
                                                            the_time($date_format); ?></span>
                        <span class="event-summary__day"><?php $date_format = 'd';
                                                            the_time($date_format); ?></span>
                    </a>
