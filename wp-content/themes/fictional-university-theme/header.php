...
<body <?php body_class(); ?>>
    <header class="site-header">
        <div class="container">
            ...
            <a class="js-search-trigger site-header__search-trigger" href="
            <?php
            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    <ul>
                        <!--control statements are to make yellow current class if we're on that page -->

                        <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 12) echo 'class="current-menu-item"' ?>><a href="
